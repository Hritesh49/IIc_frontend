            ...
            <Box sx={{ width: '100%', height: '100dvh', display: 'flex', justifyContent: 'center', alignItems: 'center', background: `url(./back.jpg)`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat',flexDirection:'column'}}>
                <Stack gap={6} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Stack gap={4} sx={{ color: 'whitesmoke', textAlign: 'center', display: 'flex', flexDirection: 'row', width: '100%', justifyContent: 'center', alignItems: 'center' }}>
                        <Button onClick={scrollToAbout} variant='contained' sx={{ backgroundColor: "#00CED1", color: '#021E30', padding: { xs: ".375rem .5rem", md: "10px 12px" }, fontSize: { xs: '1.25rem', md: '14px' }, boxShadow: "1px 1px 8px 4px #ffffff50" }}>Get Started</Button>
                        <Button variant='contained' target="_blank" href='https://youtu.be/YGlJoF81U2E?feature=shared' sx={{ backgroundColor: "#00CED1", color: '#021E30', padding: { xs: ".375rem .5rem", md: "10px 12px" }, fontSize: { xs: '1.25rem', md: '14px' }, boxShadow: "1px 1px 8px 4px #ffffff50" }}>Watch Video</Button>
                    </Stack>
                </Stack>
